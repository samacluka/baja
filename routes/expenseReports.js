...
// GET
router.get("/", is.approved, callbacks.expenseReports.get.index);
router.get("/new", is.approved, is.Lead, callbacks.expenseReports.get.new);
router.get("/:id", is.approved, callbacks.expenseReports.get.show); //  "/expenseReports/new" must be declared first because it follows the same pattern
router.get("/:id/edit", is.approved, is.ExpenseReportAuthor, callbacks.expenseReports.get.edit);

// POST
router.post("/", is.approved, multer.upload, callbacks.expenseReports.post.new);
